...
\u{1F4C1} File Counts:`),console.log(`   CSS Files: ${o}`),console.log(`   JS Files: ${i}`),console.log(`   Other Assets: ${a}`),console.log(`   Total Files: ${o+i+a}`);}getManifest(){return this.manifest}};async function m(c="./dist",t){let s=l.join(c,"asset-manifest.js"),e=t||s;console.log("\u{1F680} Starting Asset Manifest Generation..."),console.log(`   Build Directory: ${c}`),console.log(`   Output File: ${e}`),await new p(c,e).generate();}if(typeof process<"u"&&process.argv&&process.argv[1]&&process.argv[1].includes("asset-manifest")){let c=process.argv.slice(2),t=c[0]||"./dist",s=c[1];m(t,s).catch(e=>{console.error("\u274C Error generating asset manifest:",e),process.exit(1);});}export{p as AssetManifestGenerator,m as generateAssetManifest};//# sourceMappingURL=build-time.mjs.map

var i={enabled:true,cacheNamePrefix:"celebrity-box",strategies:{js:"stale-while-revalidate",css:"stale-while-revalidate",images:"cache-first",html:"network-first",api:"network-first"},expiration:{maxEntries:100,maxAgeSeconds:86400},precache:true,backgroundSync:false};function l(t,n,a={}){let e={...i,...a};if(!e.enabled)return c(t,n);let s=`${e.cacheNamePrefix}-v1`,{appName:r}=n;return `/**
...
`:""}function h(t,n={},a){let e=a?.manifest||{},s={name:e.name||t.appName||"App",short_name:e.short_name||(t.appName||"App").replace(/\s+/g,"").substring(0,12),description:e.description||`PWA for ${t.appName||"App"} with offline support`,theme_color:e.theme_color||(t.loadingTheme==="gradient"?"#667eea":"#2c3e50"),background_color:e.background_color||"#ffffff",display:e.display||"standalone",orientation:e.orientation||"portrait",scope:e.scope||"/",start_url:e.start_url||"/",icons:e.icons||[{src:"/icon-192x192.png",sizes:"192x192",type:"image/png"},{src:"/icon-512x512.png",sizes:"512x512",type:"image/png"},{src:"/icon-512x512.png",sizes:"512x512",type:"image/png",purpose:"maskable"}],categories:["utilities","productivity"],shortcuts:[{name:"Home",short_name:"Home",description:"Go to home page",url:"/",icons:[{src:"/icon-192x192.png",sizes:"192x192"}]}]};return JSON.stringify(s,null,2)}export{h as generatePWAManifest,p as generateServiceWorkerRegistration,l as generateWorkboxServiceWorker};//# sourceMappingURL=workbox.mjs.map
//# sourceMappingURL=workbox.mjs.map
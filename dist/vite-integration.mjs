function d(s,o){let{appName:e,loadingTheme:t,customTheme:n}=o,i=n||(t==="gradient"?"background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);":"background: #2c3e50;");return `/**
